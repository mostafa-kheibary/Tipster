...
export const calculateTooltipPosition = (element, positionWritable, offset, id) => {
    ...
    if (['top', 'bottom'].includes(position) && overflowsTop && overflowsBottom)
        ...
        if (overflowsTop && position === 'top')
            position = 'bottom';
        else if (overflowsBottom && position == 'bottom')
            position = 'top';
        else if (overflowsRight && position === 'right')
            position = 'left';
        else if (overflowsLeft && position === 'left')
            position = 'right';
    }
